"""
Improved Streamlit App with modular structure and error handling.
Main entry point for the Soil Moisture Prediction application.
"""
...
if predict_btn:
    ...
    # Models used and historical years (only XGBoost and LightGBM)
    models_to_show = ['XGBoost', 'LightGBM']
